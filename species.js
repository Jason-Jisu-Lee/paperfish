const SPECIES = [
  {
    file: 'paperminnow', hatch: 0, name: 'firstF', vb: [340, 200], sw: 6.5, len: 74,
    gpm: 1, cost: 50, unlock: 0, life: 5, adultAt: 2.5, hunger: true, tick: 5, phases: [1, 2],
    paths: ['M310 100 Q180 10 30 148', 'M310 100 Q180 190 30 52']
  },
  {
    file: 'perch', hatch: 30, name: 'secondF', vb: [170, 64], sw: 4.8, len: 92, swf: 0.78,
    gpm: 3, cost: 25, unlock: 100, life: 3, tick: 5, phases: [1, 2, 3, 4, 6],
    paths: ['M30 32 C64 12 128 10 164 32', 'M30 32 C64 52 128 54 164 32', 'M4 8 L30 32 L4 56 Z', 'M60 16 L74 2 L87 14']
  },
  {
    file: 'minnow', hatch: 40, name: 'Sardine', vb: [170, 50], sw: 4.6, len: 74,
  ...
  {
    file: 'mackerel', hatch: 80, name: 'Mackerel', vb: [165, 56], sw: 4.3, len: 92,
  ...
  {
    file: 'pike', hatch: 90, name: 'Pike', vb: [175, 48], sw: 3.7, len: 108,
    gpm: 610, cost: 390625, unlock: 1562500,
    paths: ['M29 26 C60 10 132 12 171 28 C132 42 62 40 29 26 Z', 'M4 4 L29 26 L4 46 Z']
  },
  {
    file: 'ray', hatch: 100, name: 'Ray', vb: [200, 140], sw: 3, len: 126,
    gpm: 1526, cost: 1953125, unlock: 7812500,
    paths: ['M2 70 C58 68.5 100 52 112 2 C126 8 150 52 190 65.5 C196 67.5 198 68.6 198 70 C198 71.4 196 72.5 190 74.5 C150 88 126 132 112 138 C100 88 58 71.5 2 70 Z']
  },
  {
    file: 'jelly', hatch: 110, name: 'Jellyfish', vb: [82, 90], sw: 3.2, len: 52,
  ...
  {
    file: 'seahorse', hatch: 120, name: 'Seahorse', vb: [56, 92], sw: 4.3, len: 42, mirror: true,
  ...
  {
    file: 'angler', hatch: 130, name: 'Anglerfish', vb: [112, 70], sw: 4.5, len: 96, mirror: true,
